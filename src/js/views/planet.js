...
export const Planet = props => {
	...
	const getPlanet = async () => {
		const planet = await actions.request(`/planets/${params.id}`)
		setPlanet(planet.properties)
	}
	...
	return (
		<div className="jumbotron planet-container">
			{!empty(planet) ? <>
				<div className="container text-center">
					<div className="row">
						<div className="col image">
							<img src={params.id === '1' ? tatooinePlanet : `${urlImage}/${params.id}.jpg`} alt="planet image" />
						</div>
						<div className="col">
